$(document).ready(function() {
	...
	function getTaiwanWeather(city_name) {
		...
		.done(function(arr) {
            ...
            //紫外線 #UVI
			var UVI_value = arr.cwbopendata.dataset.locations.location[test].weatherElement[13].time[0].elementValue[0].value;
			var UVI_measures = arr.cwbopendata.dataset.locations.location[test].weatherElement[13].time[0].elementValue[0].measures;
			var UVI_1=UVI_measures+" : "+UVI_value;
			$("#UVI").text(UVI_1);
